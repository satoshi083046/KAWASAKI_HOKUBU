...
'------------------------------------------
	...
	'--------------------------
	if EDC1USE=1 and not(DispMsg1Item=EDC1) then
		EDC1Act=1
	else 
		EDC1Act=0
	end if
	'--------------------------
	if EDC2USE=1 and not(DispMsg1Item=EDC2) then
		EDC2Act=1
	else 
		EDC2Act=0
	end if
	'--------------------------
	if EDC3USE=1 and not(DispMsg1Item=EDC3) then
		EDC3Act=1
	else 
		EDC3Act=0
	end if
	'--------------------------
	if EDC4USE=1 and not(DispMsg1Item=EDC4) then
		EDC4Act=1
	else 
		EDC4Act=0
	end if
	'--------------------------
	if EDC5USE=1 and not(DispMsg1Item=EDC5) then
		EDC5Act=1
	else 
		EDC5Act=0
	end if
	'--------------------------
	if EDC6USE=1 and not(DispMsg1Item=EDC6) then
		EDC6Act=1
	else 
		EDC6Act=0
	end if
	'--------------------------
	if Frenic1USE=1 and not(DispMsg1Item=Frenic1) then
		Frenic1Act=1
	else
		Frenic1Act=0
	end if
	'--------------------------
	if Frenic2USE=1 and not(DispMsg1Item=Frenic2) then
		Frenic2Act=1
	else
		Frenic2Act=0
	end if
	'--------------------------
	if Frenic3USE=1 and not(DispMsg1Item=Frenic3) then
		Frenic3Act=1
	else
		Frenic3Act=0
	end if
	...
	'end if
	'--------------------------
	if Frenic10USE=1 and not(DispMsg1Item=Frenic10) and MC58_洗浄ポンプA then
		Frenic10Act=1
	else
		Frenic10Act=0
	end if
	'--------------------------
	if Frenic11USE=1 and not(DispMsg1Item=Frenic11) and MC59_洗浄ポンプB then
		Frenic11Act=1
	else
		Frenic11Act=0
	end if
	'--------------------------
	if Frenic12USE=1 and not(DispMsg1Item=Frenic12) and MC60_洗浄ポンプC then
		Frenic12Act=1
	else
		Frenic12Act=0
	end if
	'--------------------------
	if Frenic13USE=1 and not(DispMsg1Item=Frenic13) and MC61_洗浄ポンプD then
		Frenic13Act=1
	else
		Frenic13Act=0
	end if
