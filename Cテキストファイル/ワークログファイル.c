...
'生産情報ファイル書込み
	...
	case 4
		...
		'-------------------------------
		'生産情報
		WriteStepstr="Aタンク送米設定値" +","+ DASC(DM_Aタンク設定値.U,1)+","
		...
		WriteStepstr=WriteStepstr+"設定水量"+","+DASC(DM_計水目標下限1.U,1)+","
		'----------------------------------------------------------------------
		'ファイル書込み文字列		
...
'現在情報ファイル書込み
	...
	case 4
		...
		realWriteStepstr=realWriteStepstr+"設定水量"+","+DASC(DM_計水目標下限1.U,1)+","
		'----------------------------------------------------------------------
		'ファイル書込み文字列		
